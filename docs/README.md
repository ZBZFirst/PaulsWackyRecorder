...
This folder contains the primary human-facing documentation for the current app architecture and in-progress validation model.
...
- `PaulsUSDatasetExplained.md`
  - Explains workbook-driven validation concepts in `PaulsUSDataset.xlsx`.
